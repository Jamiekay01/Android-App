...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public void addNewProduct(String productName, String buyingPrice, String sellingPrice, String productCategory) {
        ...
        values.put(DURATION_COL, buyingPrice);
        values.put(DESCRIPTION_COL, sellingPrice);
        values.put(TRACKS_COL, productCategory);
    ...
    public ArrayList<ProductModal> readProduct() {
        ...
        Cursor cursorProduct = db.rawQuery("SELECT * FROM " + TABLE_NAME, null);
